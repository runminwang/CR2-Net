...
def default_evaluation_params():
    ...
    return {
                ...
                'GT_SAMPLE_NAME_2_ID':'Test_([0-9]+)_([0-9]+).txt',
                'DET_SAMPLE_NAME_2_ID':'Test_([0-9]+)_([0-9]+).txt',
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    # k1 = input("k1:")
    # if k1==5:
    #     methodRecall = 0 if numGlobalCareGt == 0 else float(matchedSum)/numGlobalCareGt#1
